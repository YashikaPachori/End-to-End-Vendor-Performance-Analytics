print("get_vendor_summary.py started")
...
def create_vendor_summary(conn):
    "this function will merge the deifferent tables to get the overall vendor summary and adding new columns in the resultant data"""
